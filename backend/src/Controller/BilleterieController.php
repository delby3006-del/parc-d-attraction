...
final class BilleterieController extends AbstractController
{
    ...
    #[Route('/getMaxPrices', name: 'get_max_prices', methods: ['GET'])]
    public function getMaxPrices(OffreBilletterieRepository $obr): JsonResponse
    {
        $maxs = $obr->findgetMaxPrices();
        return $this->json($maxs);
    }
